...
public class Html5ArticleTikaFormatExtractorIT extends AbstractTikaFormatExtractorIT {

  private static final String RESOURCE_NAME = "html5-article.html";

  public Html5ArticleTikaFormatExtractorIT() {
    super(RESOURCE_NAME);
  }
