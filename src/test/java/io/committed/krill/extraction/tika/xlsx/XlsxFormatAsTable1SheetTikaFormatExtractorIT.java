...
public class XlsxFormatAsTable1SheetTikaFormatExtractorIT
    extends AbstractTikaSpreadsheetFormatExtractorIT {
  private static final String RESOURCE_NAME = "formatastable-1sheet.xlsx";

  public XlsxFormatAsTable1SheetTikaFormatExtractorIT() {
    super(RESOURCE_NAME);
  }
