...
public class XlsInlineFormatting1SheetTikaFormatExtractorIT
    extends AbstractTikaSpreadsheetFormatExtractorIT {

  private static final String RESOURCE_NAME = "inlineformatting-1sheet.xls";

  public XlsInlineFormatting1SheetTikaFormatExtractorIT() {
    super(RESOURCE_NAME);
  }
