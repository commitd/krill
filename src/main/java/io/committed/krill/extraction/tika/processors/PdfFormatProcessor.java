 ...
 *
 * <p>Attempts to wrap up a PDF as a document see {@link WordFormatProcessor} for details.
 *
 * <p>PDF has the advantage over Word that it understand pages. As such under the main class is a
...
public class PdfFormatProcessor extends AbstractJsoupFormatProcessor {
  ...
  private void convertBreaksBetweenPages(final Document document) {
    document
        .select("article.page ~ article.page")
        .forEach(
            a -> {
