 ...
 *
 * <p>Tika attempts to get text content from many document sources, but it does little to
 * standardise their output. Furthermore the results of Tika's processing can be very noisy, with
 * excessive tags derived from semnatic, syntax or stylistic extractions.
 *
 * <p>The role of a format processor is to convert the HTML output of Tika into a cleaner, more
 ...
 *
 * <p>Implementations of this should be plugin into {@link TikaFormatExtractor} through addProcessor
 * function.
 *
 * <p>NOTE since the majority of work in a format processor is HTML manipulation most implementation
